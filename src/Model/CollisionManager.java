...
public class CollisionManager {
    ...
    public static void blockCollision(Ball ball, ArrayList<Rectangle> blockList, Group group) {
        int hitTop = 0;
        int hitBottom = 0;
        int hitRight = 0;
        int hitLeft = 0;
        ...
        for (int i = blockList.size()-1; i >= 0; i--){
            Rectangle block = blockList.get(i);
            if (ball.getCircle().getBoundsInParent().intersects(block.getBoundsInParent())) {
                hitCount++;
