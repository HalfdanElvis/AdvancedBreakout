...
public class GenerateBlocks {
    public static ArrayList<Rectangle> generateBlocks(double rows, double columns) {
        ...
        double space = View.GameView.getSceneWidth()/Math.sqrt(columns)/Math.sqrt(rows)/40;
        double blockWidth = View.GameView.getSceneWidth()/columns-space;;
        double blockHeight = View.GameView.getSceneHeight()/3/rows-space;
